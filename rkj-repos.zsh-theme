...
function mygit() {
  ...
  echo "$ZSH_THEME_GIT_PROMPT_PREFIX${ref#refs/heads/}$( git_prompt_status )%{\e[0;34m%}%B$ZSH_THEME_GIT_PROMPT_SUFFIX"
}
...
%{\e[0;34m%}%B└─%B[%{\e[1;35m%}$%{\e[0;34m%}%B] $(mygit)$(hg_prompt_info)%{\e[0;34m%}%B>%{\e[0m%}%b '
